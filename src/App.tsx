        ...
        <div className="bg-radial min-h-screen">
            ...
            <nav className="nav-netflix">
                ...
                <div className="flex gap-8 items-center font-medium">
                    <button
                        onClick={() => setView('home')}
                        className={`hover:text-white transition-colors border-none bg-transparent cursor-pointer font-bold ${view === 'home' ? 'text-white underline underline-offset-8' : 'text-gray-400'}`}
                    >
                        Home
                    </button>
                    <button
                        onClick={() => setView('privacy')}
                        className={`flex items-center gap-2 hover:text-white transition-colors border-none bg-transparent cursor-pointer font-bold ${view === 'privacy' ? 'text-white underline underline-offset-8' : 'text-gray-400'}`}
                    >
                        <Shield size={18} />
                        Privacy
                    </button>
